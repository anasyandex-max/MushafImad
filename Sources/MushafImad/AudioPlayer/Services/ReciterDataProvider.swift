...
public struct ReciterDataProvider {
    public static let reciters: [ReciterCatalogEntry] = [
        ReciterCatalogEntry(
            ...
            timingSource: .both(itqanAssetId: 11)
        ),
        ReciterCatalogEntry(
            id: 5,
        ...
        // Itqan-only reciters. Their actual MP3 URL is resolved from the Itqan API.
        ReciterCatalogEntry(
            id: 1001,
            nameArabic: "بدر التركي",
            nameEnglish: "Badr Al-Turki",
            rewaya: "حفص عن عاصم",
            folderURL: "https://api.cms.itqan.dev/",
            timingSource: .itqan(assetId: 11)
        ),
        ReciterCatalogEntry(
            id: 1002,
            ...
            rewaya: "حفص عن عاصم",
            folderURL: "https://api.cms.itqan.dev/",
            timingSource: .itqan(assetId: 12)
        ),

        // Audio-only MP3Quran reciter. There is no bundled timing JSON in this package for this ID.
        // Downloads and chapter playback work. Verse-level seeking/highlighting requires adding timing data.
        ReciterCatalogEntry(
            id: 1003,
            nameArabic: "محمد صديق المنشاوي",
            nameEnglish: "Mohammed Siddiq Al-Minshawi",
            rewaya: "حفص عن عاصم",
            folderURL: "https://server10.mp3quran.net/download/minsh/",
            timingSource: .mp3quran
        )
    ]

    public static func getReciterInfo(
        id: Int
    ) -> (
        nameArabic: String,
        nameEnglish: String,
